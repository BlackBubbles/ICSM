...
Version: 1.0.0
Description:
    The following python module contains the configuration data for the "Search" panel
'''
...
'''
'''
The following variable contains the alternative browsing label for the panel browse button
'''
