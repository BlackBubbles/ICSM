...
class LabG:
  ...
  '''
  The following function returns the builder for this instance of the "Lab" panel
  '''
  def getBuilder(self):
    return self.builder

  '''
  The following function sets the builder for this instance of the "Lab" panel. If the input does not meet the
  ...
  def setBuilder(self, builder):
    if hasattr(builder, "confirm"):
      if builder.confirm("Builder"):
        ...
        return False, "%s:\nbuilder for LabG is not GUIBuilder" % ERROR
    else:
      return False, "%s:\ninput is not a file for the ICSM program" % ERROR
    return True, ""

  '''
  The following function returns the model for this instance of the "Lab" panel
  '''
  def getData(self):
    return self.data

  '''
  The following function sets the model for this instance of the "Lab" panel. If the input does not meet the
  requirements then the function returns a "False" boolean value and an error message
  '''
  def setData(self, data):
    if hasattr(data, "confirm"):
      if data.confirm("Lab"):
        ...
        return False, "%s:\ndata for LabG is not labData" % ERROR
    else:
      return False, "%s:\ninput is not a file for the ICSM program" % ERROR
    return True, ""
